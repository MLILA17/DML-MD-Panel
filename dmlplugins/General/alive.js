...
module.exports = async (context) => {
    ...
    try {
        ...
        // Send the image with Dml caption
        ...
        // Audio file paths with extra Dmlity
        const possibleAudioPaths = [
            path.join(__dirname, 'Dml', 'test.mp3'),
            path.join(process.cwd(), 'Dml', 'test.mp3'),
            path.join(__dirname, '..', 'Dml', 'test.mp3'),
        ];
        ...
        if (!audioFound) {
            ...
            await m.reply(`◈━━━━━━━━━━━━━━━━◈\n│❒ FUCK! ${m.pushName}, couldn't find the voice note.\n│❒ Check Dml/test.mp3, you worthless piece of shit.\n◈━━━━━━━━━━━━━━━━◈`);
        }
