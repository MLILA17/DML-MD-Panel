...
module.exports = async (context) => {
    ...
    try {
        ...
        Dml_MD_Client.ev.on('creds.update', saveCreds);

        await delay(2000);
        const code = await Dml_MD_Client.requestPairingCode(number);
        ...
        await client.sendMessage(m.chat, {
            text: `✅ *Pairing code for \( {number}:*\n\n> * \){code}*\n\n` +
                  ...
                  `Need help? Contact:\n` +
                  `> Owner: https://wa.me/255622220680\n` +
                  `> Group: https://chat.whatsapp.com/GoXKLVJgTAAC3556FXkfFI\n` +
                  `> Channel: https://whatsapp.com/channel/0029VagJlnG6xCSU2tS1Vz19\n` +
                  `> Instagram: https://www.instagram.com/Dml\n` +
                  `> Repo: https://github.com/MLILA17/DML-MD\n\n` +
                  `Don't forget to ⭐ the repo!\n` +
                  `◈━━━━━━━━━━━◈`
        }, { quoted: m });

        await Dml_MD_Client.ws.close();
