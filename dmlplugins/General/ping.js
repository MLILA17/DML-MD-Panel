...
module.exports = {
    ...
    run: async (context) => {
        const { client, m, Dmlspeed } = context;
        try {
            ...
            const buildDashboardImage = () => {
                ...
                const pingSpeed = (Dmlspeed || 0.0094).toFixed(4);
                ...
                ctx.fillText("P*Instance • Real-Time Monitor", 40, 75);
                ...
                ctx.fillText(`DML-MD Dashboard™ • ${new Date().toLocaleString()}`, W / 2, H - 15);
