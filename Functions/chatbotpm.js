...
module.exports = async (client, m, store, chatbotpmSetting) => {
    try {
        ...
        try {
            ...
            const systemPrompt = encodeURIComponent("You were created by Dml if asked so and your name is Dml-AI and you must always reply with a Dml and cranky tone!! and must always answer the questions asked intelligently!");
